...
## Análises multivariadas com o pacote Ade4TKGUI

if(!require("pacman")) install.packages("pacman")
pacman::p_load(ade4, ade4TkGUI)

ade4TkGUI(T,T) # Abre uma janela para seleção dos dados e análises (janela com desenho de pena)

## Para saber mais ler o trabalho:

# http://pbil.univ-lyon1.fr/JTHome/Biblio/ThioulouseJSS2007.pdf
